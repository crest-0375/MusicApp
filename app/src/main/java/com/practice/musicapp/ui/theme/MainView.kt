package com.practice.musicapp.ui.theme
...
import com.practice.musicapp.MainViewModel
import com.practice.musicapp.R
import com.practice.musicapp.Screen
import com.practice.musicapp.screensInBottom
import com.practice.musicapp.screensInDrawer
        ...
        Scaffold(bottomBar = bottomBar, topBar = {
            TopAppBar(title = { Text(title.value) }, actions = {
                ...
                IconButton(onClick = {
                    ...
                    Icon(
                        imageVector = Icons.Default.AccountCircle, contentDescription = "Menu"
                    )
                }
            })
